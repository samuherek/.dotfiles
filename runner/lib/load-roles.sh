...
load_roles() {
    ...
    ROLE_APP_GROUPS_ACCUM=""
    ROLE_HOTKEY_GROUPS_ACCUM=""
    ROLE_SCRIPT_GROUPS_ACCUM=""
    ...
    for role in $roles; do
        ...
        case "$platform" in
            macos)
                ...
                ROLE_APP_GROUPS_ACCUM="$(merge_lists "$ROLE_APP_GROUPS_ACCUM" "$ROLE_APP_GROUPS_MACOS")"
                ROLE_HOTKEY_GROUPS_ACCUM="$(merge_lists "$ROLE_HOTKEY_GROUPS_ACCUM" "$ROLE_HOTKEY_GROUPS_MACOS")"
                ROLE_SCRIPT_GROUPS_ACCUM="$(merge_lists "$ROLE_SCRIPT_GROUPS_ACCUM" "$ROLE_SCRIPT_GROUPS_MACOS")"
                ;;
            linux)
    ...
    ROLE_APP_GROUPS="$ROLE_APP_GROUPS_ACCUM"
    ROLE_HOTKEY_GROUPS="$ROLE_HOTKEY_GROUPS_ACCUM"
    ROLE_SCRIPT_GROUPS="$ROLE_SCRIPT_GROUPS_ACCUM"
}
